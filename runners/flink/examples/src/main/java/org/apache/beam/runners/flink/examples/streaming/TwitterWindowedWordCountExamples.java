 ...
 * */
public class TwitterWindowedWordCountExamples {
  ...
  public static void main(String[] args) throws IOException {
    ...
    EndpointInitializer customEp = new TwitterSource.EndpointInitializer() {
      @Override
    ...
    SourceFunction twitterSource;
    twitterSource = new TwitterSource(params.getProperties());
    // streamSource.setCustomEndpointInitializer( customEp );
